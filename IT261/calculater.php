        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
            <fieldset>
                ...
                <select name="mpg">
                    ...
                    <option value="10" <?php if(isset($_POST['mpg']) && $_POST['mpg'] == '10') echo 'selected="selected"';?> >Not good @ 10 mpg</option>
                    <option value="15" <?php if(isset($_POST['mpg']) && $_POST['mpg'] == '15') echo 'selected="selected"';?>>Little Better @ 15 mpg</option>
                    <option value="25" <?php if(isset($_POST['mpg']) && $_POST['mpg'] == '25') echo 'selected="selected"';?>>Better @ 25 mpg</option>
                    <option value="35" <?php if(isset($_POST['mpg']) && $_POST['mpg'] == '35') echo 'selected="selected"';?>>That'll do! @ 35 mpg</option>
                </select>
