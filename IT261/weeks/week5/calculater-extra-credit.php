...
<body class="<?php if(isset($_POST['weather'])) echo htmlspecialchars($_POST['weather']);?>">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
        ...
        <option value="16.00" <?php if(isset($_POST['mpg'])&& $_POST['mpg'] == 10.00) echo 'selected = "selected"' ;?> >Truck @ 16mpg</option>
        
        <option value="26.00" <?php if(isset($_POST['mpg'])&& $_POST['mpg'] == 22.00) echo 'selected = "selected"' ;?> >Average Car @ 26mpg</option>

        <option value="48.00" <?php if(isset($_POST['mpg'])&& $_POST['mpg'] == 52.00) echo 'selected = "selected"' ;?> >Hybrid Car @ 48mpg</option>
